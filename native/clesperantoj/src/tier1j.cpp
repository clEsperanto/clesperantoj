...
ArrayJ Tier1::kuwahara_filter(DeviceJ * device, ArrayJ * src, ArrayJ * dst, int radius, float sigma)
{
    return ArrayJ{cle::tier1::kuwahara_filter_func(device->get(), src->get(), dst == nullptr ? nullptr : dst->get(), radius, sigma)};
}
