...
public class Tier3 {
	 ...
	 * @throws NullPointerException if any of the device or input parameters are null.
	 */
    public static ArrayJ artificialTissue(DeviceJ device, int width, int height, int depth, float delta_x, float delta_y, float delta_z, float sigma_x, float sigma_y, float sigma_z) {
        Objects.requireNonNull(device, "device cannot be null");
        return new ArrayJ(net.clesperanto._internals.kernelj.Tier3.artificial_tissue(device.getRaw(), width, height, depth, delta_x, delta_y, delta_z, sigma_x, sigma_y, sigma_z));
    }
	 ...
	 */
	@Deprecated
    public static ArrayJ readIntensitiesFromMap(DeviceJ device, ArrayJ label, ArrayJ map, ArrayJ output) {
        Objects.requireNonNull(device, "device cannot be null");
		Objects.requireNonNull(label, "label cannot be null");
		Objects.requireNonNull(map, "map cannot be null");
        return new ArrayJ(net.clesperanto._internals.kernelj.Tier3.read_intensities_from_map(device.getRaw(), label.getRaw(), map.getRaw(), output == null ? null : output.getRaw()));
    }
