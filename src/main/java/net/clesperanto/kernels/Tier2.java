...
public class Tier2 {
	 ...
	 * g.
	 * , from maxima/minima detection) into a label image of the same size, assigning IDs 1, 2, …, n.
	 * @param device ({@link DeviceJ}) - Device to perform the operation on.
	 * @param input ({@link ArrayJ}) - Input image to process.
	 * @param output ({@link ArrayJ}) - Output result image. (default: None)
	 * @return {@link ArrayJ}
	 ...
	 * @param device ({@link DeviceJ}) - Device to perform the operation on.
	 * @param input ({@link ArrayJ}) - Input pointlist image to process.
	 * @param output ({@link ArrayJ}) - Output result label image. (default: None)
	 * @return {@link ArrayJ}
	 * @see <a href="https://clij.github.io/clij2-docs/reference_pointlistToLabelledSpots">reference_pointlistToLabelledSpots</a>
	 * @throws NullPointerException if any of the device or input parameters are null.
	 */
    public static ArrayJ pointlistToLabelledSpots(DeviceJ device, ArrayJ input, ArrayJ output) {
        Objects.requireNonNull(device, "device cannot be null");
		Objects.requireNonNull(input, "input cannot be null");
        return new ArrayJ(net.clesperanto._internals.kernelj.Tier2.pointlist_to_labelled_spots(device.getRaw(), input.getRaw(), output == null ? null : output.getRaw()));
    }
	 ...
	 * With the offset you have control over which slices stay: with factor 3 and offset 0, slices 0, 3, 6, … are kept; with factor 4 and offset 1, slices 1, 5, 9, … are kept.
	 * @param device ({@link DeviceJ}) - Device to perform the operation on.
	 * @param input ({@link ArrayJ}) - Input image.
	 * @param output ({@link ArrayJ}) - Output image. (default: None)
	...
	/**
	 * Generates a touch-matrix where the neighbors within a given distance range are marked as touching.
	 * It take as input a distance matrix (e.
	 * g.
	 * from a pointlist of centroids) and marks for every column the neighbors within the given distance range as 1, others as 0.
	 * The results is a touch-matrix (adjacency matrix) that can be used for further analysis.
	 * @param device ({@link DeviceJ}) - Device to perform the operation on.
	 * @param input_matrix ({@link ArrayJ}) - Input distance matrix.
	 * @param output_matrix ({@link ArrayJ}) - Output touch-matrix. (default: None)
	 * @param min_distance (float) - Minimum distance to consider a neighbor. (default: -1)
	 * @param max_distance (float) - Maximum distance to consider a neighbor. (default: -1)
	 * @return {@link ArrayJ}
	 * @throws NullPointerException if any of the device or input parameters are null.
	 */
    public static ArrayJ generateProximalNeighborsMatrix(DeviceJ device, ArrayJ input_matrix, ArrayJ output_matrix, float min_distance, float max_distance) {
        Objects.requireNonNull(device, "device cannot be null");
