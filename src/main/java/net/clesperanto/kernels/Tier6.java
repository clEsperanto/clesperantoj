...
public class Tier6 {
	 ...
	 * @return {@link ArrayJ}
	 * @see <a href="https://clij.github.io/clij2-docs/reference_proximalNeighborCountMap">reference_proximalNeighborCountMap</a>
	 * @throws NullPointerException if any of the device or input parameters are null.
	 */
    public static ArrayJ proximalNeighborCountMap(DeviceJ device, ArrayJ labels, ArrayJ output, float min_distance, float max_distance) {
        Objects.requireNonNull(device, "device cannot be null");
		Objects.requireNonNull(labels, "labels cannot be null");
        return new ArrayJ(net.clesperanto._internals.kernelj.Tier6.proximal_neighbor_count_map(device.getRaw(), labels.getRaw(), output == null ? null : output.getRaw(), min_distance, max_distance));
    }
